...
import financial.system.api.domain.pessoa.Pessoa;
import jakarta.persistence.*;
import lombok.AllArgsConstructor;
import lombok.EqualsAndHashCode;
import lombok.Getter;
import lombok.NoArgsConstructor;
import financial.system.api.domain.categoria.Categoria;
...
public class Lancamento {
    ...
    public void atualizarInformacoes(DadosAtualizacaoLancamento dados, Categoria categoria, Pessoa pessoa) {
        if (dados.lancamento() != null) { this.lancamento = dados.lancamento(); }
        if (dados.descricao() != null) { this.descricao = dados.descricao(); }
        if (dados.dataVencimento() != null) { this.vencimento = dados.dataVencimento(); }
        if (dados.dataPagamento() != null) { this.pagamento = dados.dataPagamento(); }
        if (dados.valor() != null) { this.valor = dados.valor(); }
        if (dados.observacao() != null) { this.observacao = dados.observacao(); }
        if (categoria != null) { this.idCategoria = categoria; }
        if (pessoa != null) { this.idPessoa = pessoa; }
    }
